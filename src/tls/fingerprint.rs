...
use crate::tls::cipher::suite::CipherSuite;
use crate::tls::extend::formats::EcPointFormat;
use crate::tls::extend::group::GroupType;
use crate::tls::extend::{Extension, ExtensionType};
use crate::tls::version::Version;
...
impl Fingerprint {
    ...
    pub fn default() -> HlsResult<Fingerprint> {
    ...
    pub fn set_ja3(&mut self, ja3: impl AsRef<str>) -> HlsResult<()> {
        let client_hello = self.client_hello.message.client_mut().ok_or(HlsError::NonePointer)?;
