use reqrio::{AcReq, Header, ReqExt, ReqGenExt, ALPN};

#[tokio::main]
async fn main() {
    let header=r#"POST /search/mpv?pl=1330&rt=1766674136805.7&chan_type=mobile_com HTTP/1.1
Host: e.so.com
...
Referer: https://m.so.com/s?q=2132
Accept-Encoding: gzip, deflate, br, zstd
Accept-Language: zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6
Cookie: __guid=15015764.1071255116101212729.1764940193317.2156; env_webp=1; QiHooGUID=4C8051464B2D97668E3B21198B9CA207.1766289287750; so_huid=11zCsw%2BezXwmYnSVD%2BKhAYZUu4CSa4F9CuODuLDHUiHMs%3D; __huid=11zCsw%2BezXwmYnSVD%2BKhAYZUu4CSa4F9CuODuLDHUiHMs%3D"#;
    let header=Header::try_from(header.to_string()).unwrap();
    println!("{} {}", header,header.is_empty());
    // let mut req = AcReq::new().with_alpn(ALPN::Http11).with_url("https://e.so.com/").await.unwrap();
